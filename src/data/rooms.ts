export const roomsData = [
  ...
  },
  {
    ...
    available: true,
    description:
      "Diseñada para viajeros de negocios exigentes, esta suite ejecutiva ofrece un espacio de trabajo ergonómico, conexión WiFi de alta velocidad y todas las comodidades premium que necesitas para combinar trabajo y descanso.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    available: true,
    description:
      "Espaciosa habitación diseñada para familias, con dos camas dobles y espacio adicional para que los niños jueguen. Incluye mininevera y microondas para mayor comodidad durante su estancia.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    available: true,
    description:
      "Opción económica pero confortable para viajeros con presupuesto ajustado. A pesar de su precio accesible, no compromete en limpieza y comodidades básicas.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    available: true,
    description:
      "Una suite junior elegante y moderna con zona de estar separada. Perfecta para quienes buscan un poco más de espacio y comodidades premium sin el precio de una suite completa.",
    images: [
      {
        id: 1,
