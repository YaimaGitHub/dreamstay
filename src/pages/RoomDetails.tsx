    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-2">
          ...
          {!room.isAvailable && (
            <span className="bg-red-500 text-white px-3 py-1 rounded-md text-sm font-medium">No disponible</span>
          )}
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between pb-4 border-b mb-6">
                <div>
                  <h2 className="text-xl font-semibold">{room.type} en alojamiento entero</h2>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-sm text-muted-foreground">Anfitrión desde 2023</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <p className="text-lg mb-4">
                  {room.description ||
                    `Disfruta de una lujosa habitación tipo ${room.type} con todas las comodidades que necesitas para una estancia perfecta.`}
                </p>
              </div>
