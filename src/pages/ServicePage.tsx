          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg opacity-90 mb-8">
                Personaliza tu estancia con nuestra amplia gama de servicios premium
                diseñados para hacer de tu experiencia algo verdaderamente excepcional.
              </p>
        ...
        <section className="py-12 bg-cream">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Si tienes alguna solicitud especial o necesitas un servicio que no encuentras en nuestra lista,
              no dudes en contactarnos. Haremos todo lo posible para satisfacer tus necesidades.
            </p>
